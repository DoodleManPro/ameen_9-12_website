//Menu Toggling:
    //Function for selecting elements from HTML file:
    ...
    let openTheMenu = selectElement(".bar-bg");
    let closeTheMenu = selectElement(".close-icon");
    let menu = selectElement(".navbar");
    let clickOut = selectElement(".click-out")
    let alert = selectElement(".alert")

    openTheMenu.addEventListener('click', function() {
        menu.style.right = "0px";
        clickOut.style.left = "0";
    });

    closeTheMenu.addEventListener('click', function() {
        menu.style.right = "-300px";
        clickOut.style.left = "-100%";
    });
